...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public boolean flashActived = false;
    ...
    protected boolean adjustSurfaceLayoutSize(Camera.Size previewSize, boolean portrait,
        ...
        if ((layoutWidth != this.getWidth()) || (layoutHeight != this.getHeight())  ) {
            ...
            if (mCenterPosX >= 0) {
            	...
            	//layoutParams.topMargin = (int)tmpLayoutHeight - (layoutHeight / 2);
                //layoutParams.leftMargin =  (int)tmpLayoutWidth - (layoutWidth / 2);
            	layoutParams.topMargin = 0;
                layoutParams.leftMargin = 0;
                
                if (DEBUGGING) {
                    Log.v(LOG_TAG, "Layout params - topMargin: " +  layoutParams.topMargin  + ", leftMargin: " + layoutParams.leftMargin);

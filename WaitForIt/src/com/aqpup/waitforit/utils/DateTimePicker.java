...
public class DateTimePicker extends RelativeLayout {
	 ...
	 * 
	 * try { cal.add(Calendar.MINUTE, 1); sendToDisplay(); } catch (Exception e)
	 * { e.printStackTrace(); } } }; View.OnClickListener min_minus_listener =
	 ...
	 * e) { e.printStackTrace(); } } };
	 */
	String[] months = { "Ene", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Ago",
			"Sep", "Oct", "Nov", "Dec" };
	...
	public int getMonthNumber() {
		...
		for (int i = 0; i < months.length; i++) {
			if (months[i].equals(month_display.getText().toString())) {
				month = i;
			}
		}
	 ...
	 * Integer.parseInt(hour_display.getText().toString()); }
	 * 
	 * public int getMinute() { return
	 * Integer.parseInt(min_display.getText().toString()); }
	 */

package com.aqpup.waitforit.chat;
...
//			.parse("content://com.appsrox.instachat.provider/profile");
	...
	public static final Uri CONTENT_URI_MESSAGES = Uri
			.parse("content://com.aqpup.waitforit.chat.provider/messages");
	public static final Uri CONTENT_URI_PROFILE = Uri
			.parse("content://com.aqpup.waitforit.chat.provider/profile");
	...
	static {
		...
		uriMatcher.addURI("com.appsrox.instachat.provider", "profile/#",
				...
				*/
		uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
		uriMatcher.addURI("com.aqpup.waitforit.chat.provider", "messages",
				MESSAGES_ALLROWS);
		uriMatcher.addURI("com.aqpup.waitforit.chat.provider", "messages/#",
				MESSAGES_SINGLE_ROW);
		uriMatcher.addURI("com.aqpup.waitforit.chat.provider", "profile",
				PROFILE_ALLROWS);
		uriMatcher.addURI("com.aqpup.waitforit.chat.provider", "profile/#",
				PROFILE_SINGLE_ROW);
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		case MESSAGES_ALLROWS:
			...
			if (values.get(COL_TO) == null) {
				db.execSQL(
						"update profile set count = count+1 where email = ?",
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		case MESSAGES_SINGLE_ROW:
			count = db.update(TABLE_MESSAGES, values, "_id = ?",
		...
		case PROFILE_SINGLE_ROW:
			count = db.update(TABLE_PROFILE, values, "_id = ?",
					new String[] { uri.getLastPathSegment() });
			break;
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		case MESSAGES_SINGLE_ROW:
			count = db.delete(TABLE_MESSAGES, "_id = ?",
					new String[] { uri.getLastPathSegment() });
			break;
		...
		case PROFILE_SINGLE_ROW:
			count = db.delete(TABLE_PROFILE, "_id = ?",
					new String[] { uri.getLastPathSegment() });
			break;

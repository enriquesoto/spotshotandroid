...
public class NavigationAdapter extends BaseAdapter {
	...
	ArrayList<Item_navigation_drawer> arrayitms;

	public NavigationAdapter(Activity activity, ArrayList<Item_navigation_drawer> listarry) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			Item_navigation_drawer itm = arrayitms.get(position);
			convertView = inflator.inflate(R.layout.item_fragment_navigation_drawer, null);
			// Titulo
